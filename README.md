...
La suite corre 227 pruebas: reglas de negocio de cada módulo, el control de
acceso de las quince pantallas, el filtro de periodo con rango vacío, las exportaciones en CSV, Excel y PDF, las ocho técnicas de limpieza del ETL con caso
