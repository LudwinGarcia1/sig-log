...
**Measured output of the reference run** (`--months 18 --seed 42`, under ten seconds): 120 clientes · 50 vehículos · 40 operadores · 60 rutas · **27 105 entregas** · **3 633 cargas de combustible** (72.7 per vehicle) · **565 mantenimientos** (11.3 per vehicle). The last three fall out of the generator's formulas rather than being set by hand — changing an archetype's monthly range or the refuel interval moves them. Use these figures, not estimates, in Tasks 21–23.

**Verified seeded pattern:** METROPOLITANA 57.4% late and ORIENTE 57.0% against 19.9%–23.4% for every other zone.
